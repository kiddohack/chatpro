...
import { ArrowRight, Code2, Heart, LayoutGrid, MessageSquare, Plane, ShoppingBag } from 'lucide-react'
...
const categories = [
  ...
  },
  {
    ...
    description: "Plan your perfect trip with AI assistance. Get personalized itineraries, local recommendations, and travel tips tailored to your preferences.",
    useCases: [
      {
        icon: "/placeholder.svg?height=48&width=48",
        title: "Itineraries",
  ...
  },
  {
    ...
    description: "Boost your productivity with AI-powered work assistance. From email drafting to presentation creation, we've got you covered.",
    useCases: [
      {
        icon: "/placeholder.svg?height=48&width=48",
        title: "Emails",
  ...
  },
  {
    ...
    description: "Transform your marketing efforts with AI-generated content and strategies that convert.",
    useCases: [
      {
        icon: "/placeholder.svg?height=48&width=48",
        title: "Ad Copy",
  ...
  },
  {
    ...
    description: "Get help with coding challenges, debug issues, and learn programming concepts with AI assistance.",
    useCases: [
      {
        icon: "/placeholder.svg?height=48&width=48",
        title: "Debug",
  ...
  },
  {
    ...
    description: "Achieve your health and fitness goals with personalized workout plans and nutrition advice.",
    useCases: [
      {
        icon: "/placeholder.svg?height=48&width=48",
        title: "Workouts",
  ...
  return (
    <div className="rounded-3xl bg-[#1C1C1E] p-8 md:p-12">
      <div className="text-center mb-12">
        <h2 className="text-3xl md:text-4xl font-bold mb-3">Use Cases of ChatPro</h2>
      ...
      {selectedCategory && (
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <div>
            <h3 className="text-2xl font-bold mb-4">{selectedCategory.label}</h3>
            <p className="text-gray-400 mb-8 leading-relaxed">
              {selectedCategory.description}
            </p>
            <Button variant="ghost" className="bg-[#2C2C2E] hover:bg-[#2C2C2E]/80">
